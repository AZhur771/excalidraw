...
export const IMAGE_PLACEHOLDER_IMG = document.createElement("img");
...
export const pathsStringCache = new WeakMap<ExcalidrawFreeDrawElement, string>(
  [],
);
...
export function generateFreeDrawShape(
  ...
  if (webGLEnabled) {
    pathsStringCache.set(element, svgPathData);
  } else {
